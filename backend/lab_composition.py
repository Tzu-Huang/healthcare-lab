...
def lab_server_services(app, store, *, operation_runner):
    ...
    return (
        ...
        LabHealthService(app, repository, health_checker=run_lab_server_health_check, availability_decorator=decorate_lab_operation_availability),
...
def dashboard_services(app, store, *, operation_runner):
    def health_check(repository, service_id):
        return run_dashboard_group_health_check(
            repository, service_id, health_checker=run_lab_server_health_check
        )
