...
CONFIGURATION_OWNERSHIP: dict[str, ConfigurationOwnership] = {
    **_entries(
        ...
        DCM4CHEE_CLIENT_SECRET_FILE DCM4CHEE_LDAP_IMAGE DCM4CHEE_PASSWORD_FILE
        DCM4CHEE_STORAGE_DIR DCM4CHEE_TOKEN_FILE
        GDT_BRIDGE_HOST_PATH GDT_HOST_CONTROLLER_URL LAB_APP_IMAGE LAB_APP_PORT
        MEDPLUM_ALLOWED_ORIGINS
        MEDPLUM_APP_BASE_URL MEDPLUM_APP_IMAGE MEDPLUM_APP_PORT MEDPLUM_BASE_URL
        MEDPLUM_CLIENT_SECRET_FILE MEDPLUM_IMAGE MEDPLUM_PORT MEDPLUM_POSTGRES_DB
        MEDPLUM_POSTGRES_IMAGE MEDPLUM_POSTGRES_USER MEDPLUM_PUBLIC_BASE_URL
        MEDPLUM_REDIS_IMAGE OIE_DATABASE OIE_HTTPS_PORT OIE_HTTP_PORT OIE_IMAGE
        OIE_AP_RESULT_INGRESS_HOST_PORT OIE_ORDER_INGRESS_HOST_PORT
        OPENEMR_DB_PASSWORD_FILE STORAGE_DIR
        """,
        DEPLOYMENT_ONLY,
        "Docker Compose",
