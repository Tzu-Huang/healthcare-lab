...
class FhirCoordinationTests(unittest.TestCase):
    def setUp(self):
        ...
        self.dependencies = assemble_application_dependencies(Path(self.directory.name) / "coordination.db")
        ...
        self.patient_coordinator = PatientFhirCoordinator(
            self.dependencies.patient_repository, self.ledger
        )
        self.order_coordinator = FhirOrderCoordinator(
            self.dependencies.patient_repository, self.dependencies.order_repository, self.ledger,
            timestamp_factory=lambda: "2026-07-16T09:00:00+00:00",
    ...
    def sync_patient(self, patient):
        ...
        return self.dependencies.patient_repository.get_patient_record(patient["id"])
    ...
    def test_order_requires_fhir_synced_patient_reference(self):
        ...
        coordinator = FhirOrderCoordinator(
            BadReferencePatients(), self.dependencies.order_repository, self.ledger,
            timestamp_factory=lambda: "2026-07-16T09:00:00+00:00",
            storage_timestamp_factory=lambda: "20260716090000",
            resource_builder=build_service_request,
        )
    ...
    def test_ledger_failure_occurs_after_committed_local_order(self):
        ...
        class RecordingOrders:
            def create_fhir_order_record(inner_self, *args, **kwargs):
                events.append("order")
                return self.dependencies.order_repository.create_fhir_order_record(*args, **kwargs)
        ...
        coordinator = FhirOrderCoordinator(
            self.dependencies.patient_repository, RecordingOrders(), FailingLedger(),
            timestamp_factory=lambda: "2026-07-16T09:00:00+00:00",
            storage_timestamp_factory=lambda: "20260716090000",
            resource_builder=build_service_request,
        )
        ...
        self.assertEqual(1, len(self.dependencies.order_repository.list_order_records("FHIR R4")))
