...
FRONTEND_FUNCTION_NAME_INVENTORY: frozenset[str] = frozenset("""
 actionButton appendMedplumLiveRelatedRow appendMedplumRelatedRow
...
compactTable createGdtDemoResult createGdtPatientFromOrderFlow
...
fetchMedplumDiagnosticReportsForCurrentSelection fhirConcept fhirOrderField
fhirOrderPayload fhirReferenceList fhirSyncStatusClass filteredMedplumPatients gdtActionButton
gdtPatientFormPayload gdtPatientPreviewPayload gdtPatientSection
groupDcm4cheeResultsForBrowser importGdtInboxFile
loadDcm4cheeAttemptHistory loadMedplumLiveReferencePreview loadMedplumLiveReportPreview
loadMedplumPreview measurementSummary medplumDiagnosticReportKeyMatchesCurrent
...
refreshGdtBridgeConfig refreshGdtConsole refreshMedplumInventory
...
renderMedplumReportSummaryBlocks renderMedplumResourceSelect
...
renderResources renderServices renderSummary replaceDashboardService
resetMedplumDiagnosticReportState
retryButtonForMedplumRecord retryDcm4cheeOrder retryMedplumRecord retryPatientFhirSync
...
simulateDcm4cheeApReturn splitFhirList startGdtWatcher statusClass stopGdtWatcher
