...
FRONTEND_FUNCTION_NAME_INVENTORY: frozenset[str] = frozenset("""
  appendMedplumLiveRelatedRow appendMedplumRelatedRow
...
buildPatientGdtPreviewPayload buildPatientPreviewPayload byId  clearMedplumPreview
...
patientFormPayload patientPreviewMrn patientStateLabel  refreshDcm4cheeConsole
...
saveGdtBridgeConfig selectDcm4cheeOrder
...
simulateDcm4cheeApReturn splitFhirList startGdtWatcher  stopGdtWatcher
