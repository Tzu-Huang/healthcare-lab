...
| `MEDPLUM_CLIENT_ID`, `MEDPLUM_SCOPE`, `MEDPLUM_TOKEN_URL`, `MEDPLUM_AUTH_GRACE_SECONDS` | runtime-persisted | typed Medplum settings | seed missing profile once | next effective read |
