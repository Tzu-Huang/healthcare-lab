...
- [x] 3.1 Add Visit Number to Local Orders and standardize its core columns as Order ID, mode, MRN, Visit Number, patient name, code, status, and Taipei Order Created At.
- [x] 3.2 Add Order ID, MRN, Visit Number, and Taipei Order Created At to patient-centered OIE Order rows while preserving ACK, sent time, selection, and send actions.
- [x] 3.3 Align new UI and response naming on Visit Number while retaining compatibility with the existing `visitId` Order field.
