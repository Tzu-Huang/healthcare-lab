...
- [ ] 2.1 Add persisted-result-to-viewer tests for both SOP Classes through controlled bare and multipart WADO-RS responses.
- [ ] 2.2 Assert canonical leads, 10,000 samples per channel, 1,000 Hz, 10 seconds, microvolt-to-millivolt calibration, SVG labels, viewer summary, and safety classification.
- [ ] 2.3 Add disclosure-safe regression cases for non-ECG DICOM, missing Waveform Sequence, wrong units, truncated samples, malformed multipart data, upstream failures, and unknown results.
...
- [ ] 3.2 Verify the supported local and container dependency installation paths parse and render both ECG formats without manual package installation.
...
- [ ] 4.2 Document configuration, supported SOP Class UIDs, fixture policy, runtime dependencies, stable troubleshooting categories, recovery actions, and display limitations.
