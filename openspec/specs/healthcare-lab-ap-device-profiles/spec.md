# healthcare-lab-ap-device-profiles Specification

## Purpose
TBD - created by archiving change add-ap-external-device-connection-profiles. Update Purpose after archive.
## Requirements
