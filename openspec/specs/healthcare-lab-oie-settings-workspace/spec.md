# healthcare-lab-oie-settings-workspace Specification

## Purpose
TBD - created by archiving change build-oie-settings-channel-management-ui. Update Purpose after archive.
## Requirements
